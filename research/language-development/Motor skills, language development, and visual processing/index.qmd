...
pub-info:
  ...
  links:
    ...
    - name: Add to Zotero
      ...
      icon: ai ai-zotero
    - name: PDF
      url: Kobas-2022-motor-language-visual-processing.pdf
      icon: fa-solid fa-file-pdf
      local: true
doi: 10.1007/s12144-021-02658-8
---

**In brief:** In preterm and full-term infants, visual processing mediated the link between motor skills and early language — especially for preterm infants with motor delays — supporting a developmental-cascade view in which motor ability feeds language through visual experience.
